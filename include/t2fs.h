...
t_openDirectory openedDirectories[MAX_OPEN_DIRECTORIES];

t_openFile openedFiles[MAX_OPEN_FILES];

struct t2fs_record* currentDirectory;

struct t2fs_record* rootDirectory;

struct t2fs_record* beingWorkedRecord;
